...
const ImagePixelController = require("../controllers/ImagePixelController");
...
function APIRouter(app) {
    ...
    // Middleware to add app context to req.place
    ...
    router.post("/place", [requireUser, addAppContext], PlaceController.postAPIPixel);
    router.post("/upload-image", [requireUser, addAppContext], ImagePixelController.postAPIUploadImage);
    router.post("/place-image", [requireUser, addAppContext], ImagePixelController.postAPIPlaceImagePixel);

    router.get("/timer", [requireUser, addAppContext], PlaceController.getAPITimer);
    ...
    router.get("/online", addAppContext, function(req, res, next) {
        return res.json({
            success: true,
            online: {
